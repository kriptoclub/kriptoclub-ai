...
`;
    ...
    analysis = `
Odbojni val se nadaljuje, vendar se približujemo ključni točki, kjer bomo lahko začeli govoriti o začetku novega impulzivnega vala. Ta bi lahko najprej pripeljal do ponovnega testa predhodnega vrha (wave start), v primeru preboja pa bi sledil nadaljnji dvig proti ${Math.round(fib1618)} USD.
